...
var file_hello_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0x56, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6e, 0x67, 0x12, 0x25, 0x0a, 0x07, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x0a, 0x2e,
	0x70, 0x62, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x1a, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x53,
...
var file_hello_proto_depIdxs = []int32{
	...
	0, // 1: pb.HelloService.Channel:input_type -> pb.String
	0, // 2: pb.HelloService.Hello:output_type -> pb.String
	0, // 3: pb.HelloService.Channel:output_type -> pb.String
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/pb.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
